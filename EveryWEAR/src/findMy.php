...
<?php 
	$title = "myDonation";
	$d_data = json_decode(file_get_contents("./users.json"),true)[$_SESSION["EWUID"]]["data"];
	...
	<div id="root"><?php endif ?>
		<div class="container" data-html-title="<?=$title; ?>">
			<div class="map-iframe">
				<iframe src="/module/FlightAware.html" style="
					display: block;
					margin: 10% auto;
					width: 80%;
					height: 30em;
